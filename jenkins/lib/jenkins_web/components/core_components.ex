defmodule JenkinsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JenkinsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JenkinsWeb.Gettext, "errors", msg, opts)
    end
  end
